...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(msg.sender == _owner, "Only owner can call contract");
        _; 
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
       ...
       require(newOwner != address(0), "newOwner address is invalid");
    ...
    event OwnerTransfer(address owner, address newOwner);
}
...
//  2) create a public setter using the inherited onlyOwner modifier 
   function set_Paused(bool paused) public onlyOwner {
        _paused = paused;
...
//  4) create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Paused is equal to true.");
        _;
    }

    modifier paused() {
        require(_paused == true, "Paused is equal to false.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Owner of the tokenId is equal to the given address.");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require (msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender),"msg.sender is not the owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "from address is the owner of the given token");
...
contract ERC721MintableComplete is ERC721Metadata{
    string private _name = "RealEstate";
    string private _symbol = "DMY";
